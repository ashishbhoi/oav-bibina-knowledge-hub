...
<div class="min-h-screen bg-gray-50 py-8">
	...
	<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		...
		{#if activeTab === 'classes'}
			<div class="space-y-6">
				<div class="bg-white shadow rounded-lg p-6">
					...
					>
						<h3 class="text-sm font-medium text-gray-700 mb-3">Add New Class</h3>
		...
		{#if activeTab === 'fileTypes'}
			<div class="space-y-6">
				<div class="bg-white shadow rounded-lg p-6">
					<h2 class="text-lg font-medium text-gray-900 mb-4">Manage File Types</h2>
					...
					<form
						...
						class="mb-6 p-4 border border-gray-200 rounded-lg"
					>
						<h3 class="text-sm font-medium text-gray-700 mb-3">Add New File Type</h3>
						<div class="flex gap-3">
							<input
								type="text"
								name="name"
		...
		{#if activeTab === 'subjects'}
			<div class="space-y-6">
				<div class="bg-white shadow rounded-lg p-6">
					<h2 class="text-lg font-medium text-gray-900 mb-6">Manage Subjects by Class</h2>
		...
		{#if activeTab === 'admin'}
			<div class="space-y-6">
				<div class="bg-white shadow rounded-lg p-6">
					<h2 class="text-lg font-medium text-gray-900 mb-4">Admin Account Settings</h2>
