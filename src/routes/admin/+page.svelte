...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		<div>
			...
			<p class="mt-2 text-center text-sm text-gray-600">OAV Bibina Knowledge Hub Administration</p>
		</div>
		...
		<div class="text-center">
			<a class="text-sm text-blue-600 hover:text-blue-500" href="/"> ← Back to Knowledge Hub </a>
		</div>
	</div>
</div>
