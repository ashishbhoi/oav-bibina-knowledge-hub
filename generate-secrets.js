...
console.log('3. For R2 credentials, create an API token in Cloudflare dashboard');
console.log('');
...
console.log('- R2 Documentation: https://developers.cloudflare.com/r2/api/s3/tokens/');
